...
@SourceType(value = "InformixARP", label = "Informix",uiConfig = "informix-layout.json")
public class InformixConf extends AbstractArpConf<InformixConf> {
  private static final String ARP_FILENAME = "arp/implementation/informix-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.informix.InformixDriver";
